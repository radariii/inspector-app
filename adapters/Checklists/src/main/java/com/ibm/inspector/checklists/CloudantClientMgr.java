...
public class CloudantClientMgr {
	...
	private static String databaseName = "checklists";
...
//
//		} else {
			user = "8bacdccc-570f-4047-8904-e0e00299d533-bluemix";
			password = "aac149c0d30b7c35172516a8fb426c8d533206040999840782a7d28c484b3574";
//		}
		...
		try {
			...
			throw new RuntimeException("Unable to connect to repository with user: " + user + ", password: " + password, e);
		}
	}
	...
	public static Database getDB() {
		...
		if (db == null) {
			try {
				...
				throw new RuntimeException("DB Not found: " + databaseName, e);
			}
		}
		return db;
	}
