...
@Path("/")
public class LiveUpdateSegmentsAdapterResource {

    private static final Gson gson = new Gson();
    private static final Logger logger = Logger.getLogger(LiveUpdateSegmentsAdapterResource.class.getName());
    ...
    public String getSegment(String body) throws Exception {
		...
		if (authenticatedUser != null){
			...
			System.out.println("--> LiveUpdateSegmentsAdapterResource(); user id = " + userId + ", name = " + name);
			...
			System.out.println("--> LiveUpdateSegmentsAdapterResource(); setting segment to: " + segmentName);
		} else {
			System.out.println("--> LiveUpdateSegmentsAdapterResource(); Could not find user. Setting segment to: " + segmentName);
		}
