...
__WLIndexDB = function() {
    ...
    this.init = function() {
        ...
        request.onupgradeneeded = function(event) {
            ...
            if(!db.objectStoreNames.contains(defaultCategory)) {
                db.createObjectStore(defaultCategory, {keyPath: "key"});
            }
...
__WLClient = function() {
    ...
    this.init = function (initOptions) {
        ...
        wlanalytics.init(WL.BrowserManager.getWLUniqueID(),WL.Config.__getContext(),WL.Config.__getApplicationName());
                    ...
                    loadWLClientMessages(deviceLocale).always(function() {
                        ...
                        if (typeof WL.ClientMessages === 'undefined') {
                            loadWLClientMessages(lang).always(function() {
                                ...
                                if (typeof WL.ClientMessages === 'undefined') {
                                    loadWLClientMessages('en').always(dfd.resolve);
                                } else {
                                    dfd.resolve();
                                }
                            });
